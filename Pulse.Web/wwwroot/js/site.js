...
//         case 'pulse':
//             darkC = "hsl(0,100%,20%)";
//             darkCt25 = "hsla(0,100%,20%,0.25)";
//             darkCt50 = "hsla(0,100%,20%,0.5)";
//             darkCt75 = "hsla(0,100%,20%,0.75)";
//             lightC = "hsl(0, 0%, 85%)";
//             lightC2 = "hsl(0, 0%, 75%)";
//             btnAccentBG = "#6F8D6A";
//             btnAccentColour = "rgb(255,255,255)";
//             bgPic = "PulseAspireBG.png";
//             break;
//         case 'HM':
//             darkC = "hsl(200, 40%, 30%)";
//             darkCt25 = "hsla(200, 40%, 30%, 0.25)";
//             darkCt50 = "hsla(200, 40%, 30%, 0.5)";
//             darkCt75 = "hsla(200, 40%, 30%, 0.75)";
...
//             darkCt25 = "hsla(240, 100%, 15%,0.25)"; 
//             darkCt50 = "hsla(240, 100%, 15%,0.5)"; 
//             darkCt75 = "hsla(240, 100%, 15%,0.75)"; 
...
//         case 'space':
//             darkC = "hsl(0, 0%, 0%)";
//             darkCt25 = "hsla(0, 0%, 0%, 0.25)";
//             darkCt50 = "hsla(0, 0%, 0%, 0.5)";
//             darkCt75 = "hsla(0, 0%, 0%, 0.75)";
//             lightC = "hsl(0, 0%, 86%)";
//             lightC2 = "hsl(0, 0%, 75%)";
//             btnAccentBG = "#E2552D";
//             btnAccentColour = "rgb(255,255,255)";
...
//             break;
//     }
//     sheet.replaceSync(':root { --pulse-dark-colour: ' + darkC + '; --pulse-accent-btn-theme-bg: ' + btnAccentBG + '; --pulse-accent-btn-theme-colour: ' + btnAccentColour + '; --pulse-dark-t25-colour:' + darkCt25 + '; --pulse-dark-t50-colour:' + darkCt50 + '; --pulse-dark-t75-colour:' + darkCt75 + '; --pulse-light-colour:' + lightC + '; --pulse-light-2-colour:' + lightC2 + '; --pulse-theme-bg: url(../images/backgrounds/' + bgPic + '); --accent-fill-rest: ' + darkC + '; }');
