...
//// Enable session state (backed by Redis distributed cache)
////builder.Services.AddDistributedCache(); // Already implied by Redis
//builder.Services.AddSession(options =>
//{
//    options.Cookie.IsEssential = true; // Required for auth
...
//builder.Services.AddScoped<AuthenticationStateProvider, JwtAuthenticationStateProvider>(); // Custom provider
//builder.Services.AddScoped<IAuthService, AuthService>(); // For login/register calls
