    ...
    public class Flapper
    {
        ...
        public string BuildSystemMessagev2(SystemMessageData systemMessageData)
        {
            var systemMessage = $"""
                ...
                You should address the user by their name to create a more personalized and engaging experience, and use the information you have been provided about the company and its operations to inform your responses and provide relevant and useful information possible.
